...
public class Tools {
   ...
   private String filename="do-not-exe-me";
     ...
     * @return
     */
    public static float getFloatNoBetween(int a,int b,int c){
        int i=(int)(a+Math.random()*(b-a+1));
        //float f=(float)(getNoBetween(1,c*10)%(c*10));
        float f=(float)getNoBetween(1,c*10)/(float)(c*10);
        return i+f;
    }
